...
function sonIguales(x, y) { if (x === y)
...
function esImpar(num) { if (num% 2 === 1) 
  {return true;}else{return false;}
...
function esPositivo(numero) {   if(numero === 0) {
  return false;
}
else if(numero > 0) {
  return "Es positivo";
...
function combinarNombres(nombre, apellido) { var combinados = nombre + ' ' + apellido; 
return combinados;
