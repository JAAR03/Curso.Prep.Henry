...
else if(status === 2){return'Away';} else{return 'Offline'}
...
function colors(color) {  switch(color) {case "blue":return "This is blue"; case "red":  return "This is red";
case "green": return "This is green";case "orange":return "This is orange";default: return "Color not found";
}
...
function esPrimo(numero) { if (numero < 2){return false;}
...
function tablaDelSeis(){ let arrayTablaDel6 = []
  for (let i = 0; i < 11; i++) {  arrayTablaDel6.push(6 * i)
...
function tieneTresDigitos(numero){ if (numero > 99 && numero < 2000){return true}return false
  //Leer un número entero y retornar true si tiene 3 dígitos. Caso contrario, retorna false.
  //Escribe tu código aquí
  
}

function doWhile(numero) { var a=numero
     var i= 0
      do{i=i +1 ;
      a=a +5}
       while(i<8); return a
